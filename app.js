...
let person = new Person('Chris', 'Cusack', new Date(1999,7,12));
console.log(person);
console.log(person.toString());
let anotherPerson = new Person('Pat', 'Thebeau', new Date(1990,2,18));
let oneMorePerson = new Person('Stephen', 'Carter', new Date(1990,2,12));
...
let findChris = people.filter(function(p) {return p.firstName == 'Chris' 
&& p.lastName == 'Cusack'});
